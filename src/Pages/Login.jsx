...
import { Plus, Eye, EyeOff, Mail } from 'lucide-react';
        ...
        {!showForgotPassword ? (
          <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
            ...
            <div className="space-y-3">
              <button
                ...
                disabled={isLoading}
                className="w-full flex items-center justify-center px-4 py-3 border border-gray-300 rounded-lg shadow-sm bg-white text-sm font-medium text-gray-700 hover:bg-gray-50 transition-colors disabled:opacity-50"
              >
          ...
          <form className="mt-8 space-y-6" onSubmit={handlePasswordReset}>
            ...
            <div className="flex space-x-3">
              ...
              <button
                type="submit"
                className="flex-1 bg-gradient-to-r from-blue-600 to-teal-600 text-white py-3 px-4 rounded-lg hover:from-blue-700 hover:to-teal-700 transition-all duration-300"
              >
                Send Reset Link
              </button>
            </div>
